...
using namespace std;
// Constructor principal: Crea la matriz de celdas según el tamaño pedido
Tablero::Tablero()
{
}
...
// Decide qué mostrar en cada celda: '?', '*' o el número de minas cerca
string Tablero::getRepresentacionMina(int coordenadaX, int coordenadaY)
{
    ...
    // si la celda ya se descurbriop o si el modo trampa (desarrolldor) esta activo
    if (celdaTemporal.getMinaDescubierta() || this->modoDesarrollador)
    {
        ...
        {
            // Si no es mina, calcula cuántas hay alrededor y convierte el número a texto
...
// Revisa los 8 cuadros vecinos para contar cuántas minas hay cerca
...
void Tablero::imprimirSeparadorEncabezado()
	...
	// Cuenta cuántas celdas "seguras" faltan por tocar para ganar el juego
